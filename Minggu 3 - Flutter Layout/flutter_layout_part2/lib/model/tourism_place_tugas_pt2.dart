...
var tourismPlaceList = [
  TourismPlace(
    ...
    description: 'Ubud adalah sebuah desa adat sekaligus menjadi destinasi wisata di daerah kabupaten Gianyar, pulau Bali, Indonesia. Ubud terutama terkenal diantara para wisatawan mancanegara karena terletak di antara sawah dan hutan yang berjurang-jurang yang membuat pemandangan alam sangat indah.',
    day: 'Open Everyday',
    time: '09:00-18:00',
    ticket: 'Rp 40.000,-',
  ...
  TourismPlace(
    ...
    description: 'Canggu adalah desa di kecamatan Kuta Utara, Kabupaten Badung, Bali, Indonesia. Canggu mulai terkenal setelah dibukanya Deus ex Machina. Pantainya membentang antara Kerobokan dan Pantai Echo Beach yang sejuk penuh dengan bar tepi pantai yang berwarna-warni, ombak selancar, kafe makanan lengkap, hipsters, dan gadis pantai.',
    day: 'Open Everyday',
    time: '24 Hours',
    ticket: 'Free',
  ...
  TourismPlace(
    ...
    description: 'House of Sampoerna adalah sebuah museum tembakau dan markas besar Sampoerna yang terletak di Surabaya. Gaya arsitektur dari bangunan utamanya yang dipengaruhi oleh gaya kolonial Belanda dibangun pada 1862 dan sekarang menjadi situs sejarah.',
    day: 'Open Everyday',
    time: '09:00-18:00',
    ticket: 'Free',
  ...
  TourismPlace(
    ...
    description: 'Tugu Pahlawan adalah sebuah monumen yang menjadi markah tanah Kota Surabaya. Tinggi monumen ini adalah 41,15 meter dan berbentuk lingga atau paku terbalik. Tubuh monumen berbentuk lengkungan-lengkungan (canalures) sebanyak 10 lengkungan, dan terbagi atas 11 ruas. Tinggi, ruas dan canalures mengandung makna tanggal 10, bulan 11, tahun 1945.',
    day: 'selasa-Minggu',
    time: '08:00-15:00',
    ticket: 'Rp 2.000,-',
  ...
  TourismPlace(
    ...
    description: 'Patung Sura dan Baya adalah sebuah patung yang merupakan lambang kota Surabaya. Patung ini berada di depan Kebun Binatang Surabaya. Patung ini terdiri atas dua hewan yaitu buaya dan hiu yang menjadi inspirasi nama kota Surabaya: ikan sura (hiu) dan baya (buaya).',
    day: 'Open Everyday',
    time: '24 Hours',
    ticket: 'Free',
